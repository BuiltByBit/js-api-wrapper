...
class ThreadsHelper {
    ...
    async list(sortOptions) {
        return await this.#wrapper.http().get("/threads", sortOptions);
    }
    ...
    async listAll(sortOptions) {
        return await this.#wrapper.http().listUntil("/threads", () => true, sortOptions);
    }
    ...
    async listUntil(shouldContinue, sortOptions) {
        return await this.#wrapper.http().listUntil("/threads", shouldContinue, sortOptions);
    }
    ...
    async listReplies(threadId, sortOptions) {
        return await this.#wrapper.http().get(`/threads/${threadId}/replies`, sortOptions);
    }
    ...
    async listRepliesAll(threadId, sortOptions) {
        return await this.#wrapper.http().listUntil(`/threads/${threadId}/replies`, () => true, sortOptions);
    }
    ...
    async listRepliesUntil(threadId, shouldContinue, sortOptions) {
        return await this.#wrapper.http().listUntil(`/threads/${threadId}/replies`, shouldContinue, sortOptions);
    }
