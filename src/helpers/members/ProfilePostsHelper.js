...
class ProfilePostsHelper {
    ...
    async list(sortOptions) {
        return await this.#wrapper.http().get("/members/self/profile-posts", sortOptions);
    }
    ...
    async listAll(sortOptions) {
        return await this.#wrapper.http().listUntil("/members/self/profile-posts", () => true, sortOptions);
    }
    ...
    async listUntil(shouldContinue, sortOptions) {
        return await this.#wrapper.http().listUntil("/members/self/profile-posts", shouldContinue, sortOptions);
    }
